  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#080d1a]/90 backdrop-blur-xl border-b border-white/5 py-3"
          : "bg-transparent py-5"
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-lg bg-linear-to-br from-[#00d4aa] to-[#4ade80] flex items-center justify-center shadow-lg shadow-[#00d4aa]/20">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            to="/register"
            className="text-sm font-medium bg-[#00d4aa] text-[#080d1a] px-5 py-2.5 rounded-lg hover:opacity-90 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
          >
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#0d1526] border-t border-white/5 px-6 py-4 flex flex-col gap-4">
          ...
          <div className="border-t border-white/5 pt-4 flex flex-col gap-3">
            ...
            <Link
              to="/register"
              className="text-sm font-medium text-center bg-[#00d4aa] text-[#080d1a] px-5 py-2.5 rounded-lg"
            >
              Commencer gratuitement
            </Link>
          </div>
