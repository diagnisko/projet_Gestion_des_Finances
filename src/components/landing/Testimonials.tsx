const testimonials = [
  ...
  },
  {
    ...
    avatar: "FN",
    color: "bg-[#c2410c]/20 text-[#c2410c]",
    stars: 5,
...
const Stars = ({ count }: { count: number }) => (
  <div className="flex gap-0.5 mb-3">
    {Array.from({ length: count }).map((_, i) => (
      <svg key={i} width="12" height="12" viewBox="0 0 12 12" fill="#c2410c">
...
const Testimonials = () => {
  return (
    <section id="testimonials" className="py-24 px-6 relative overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#3b82f6]/8 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={badge.label} className="glass-card rounded-2xl p-5 text-center">
              <p className="font-display font-bold text-2xl text-[#3b82f6] mb-1">{badge.val}</p>
