...
const DashboardMockup = () => (
  <div className="relative animate-fade-up delay-500">
    {/* Glow */}
    <div className="absolute -inset-px rounded-2xl bg-linear-to-b from-[#00d4aa]/20 to-transparent blur-xl pointer-events-none" />

    <div className="relative bg-[#0d1526] border border-white/10 rounded-2xl overflow-hidden shadow-2xl shadow-black/50">
      {/* Window bar */}
      <div className="flex items-center gap-2 px-4 py-3 bg-[#111c30] border-b border-white/5">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: "Solde total", value: "4 820 000 F", color: "text-[#00d4aa]", icon: "💰" },
            { label: "Revenus", value: "+1 200 000 F", color: "text-[#4ade80]", icon: "📈" },
            { label: "Dépenses", value: "-380 000 F", color: "text-[#f87171]", icon: "📉" },
          ].map((card) => (
            ...
            {[45, 62, 38, 78, 55, 90, 67, 85, 48, 72, 58, 95].map((h, i) => (
              <div
                ...
                style={{
                  height: `${h}%`,
                  background: i === 11
                    ? "linear-gradient(to top, #00d4aa, #4ade80)"
                    : "rgba(0,212,170,0.25)",
          ...
          <div className="space-y-2.5">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                ...
                <span className={`text-xs font-display font-semibold shrink-0 ${t.neg ? "text-[#f87171]" : "text-[#4ade80]"}`}>
                  {t.amt}
                </span>
              </div>
            ))}
...
const Hero = () => {
  return (
    <section className="relative min-h-screen grid-bg flex flex-col items-center justify-center pt-24 pb-16 px-6 overflow-hidden">
      {/* Orbs */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#00d4aa]/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#4ade80]/6 rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute top-1/2 left-1/4 w-[300px] h-[300px] bg-[#f59e0b]/5 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-[#00d4aa]/10 border border-[#00d4aa]/25 text-[#00d4aa] text-xs font-medium px-4 py-1.5 rounded-full mb-6 animate-fade-up">
            ...
            <div className="flex flex-wrap gap-3 mb-12 animate-fade-up delay-300">
              <Link
                to="/register"
                className="inline-flex items-center gap-2 bg-[#00d4aa] text-[#080d1a] font-medium px-6 py-3 rounded-xl text-sm hover:opacity-90 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 shadow-lg shadow-[#00d4aa]/20"
              >
