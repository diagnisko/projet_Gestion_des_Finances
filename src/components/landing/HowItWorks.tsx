const steps = [
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <circle cx="14" cy="11" r="5" stroke="#00d4aa" strokeWidth="1.5"/>
        <path d="M6 24c0-4.418 3.582-8 8-8s8 3.582 8 8" stroke="#00d4aa" strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M20 6l2 2 4-4" stroke="#00d4aa" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <rect x="3" y="7" width="22" height="16" rx="3" stroke="#4ade80" strokeWidth="1.5"/>
        <path d="M3 12h22" stroke="#4ade80" strokeWidth="1.5"/>
        <path d="M8 17h4M18 17h2" stroke="#4ade80" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path d="M4 22V8l10-4 10 4v14" stroke="#f59e0b" strokeWidth="1.5" strokeLinejoin="round"/>
        <rect x="10" y="14" width="8" height="8" rx="1" stroke="#f59e0b" strokeWidth="1.5"/>
        <path d="M14 8v6" stroke="#f59e0b" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-24 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-[#0d1526] border border-white/8 rounded-2xl p-6 space-y-3">
            ...
            {[
              { cat: "🍽️ Alimentation", budget: 150000, spent: 112000, color: "#00d4aa" },
              { cat: "🚌 Transport", budget: 60000, spent: 58000, color: "#f59e0b" },
              { cat: "🎮 Loisirs", budget: 50000, spent: 71000, color: "#f87171" },
              { cat: "🏠 Logement", budget: 200000, spent: 200000, color: "#4ade80" },
              ...
              return (
                <div key={item.cat}>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <span className={`text-xs font-display font-semibold ${over ? "text-[#f87171]" : "text-[#8899bb]"}`}>
                  ...
                  <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${pct}%`,
                        background: over ? "#f87171" : item.color,
                      }}
                    />
                  </div>
                </div>
          ...
          {/* Right — text */}
          <div>
            <span className="inline-block bg-[#f59e0b]/10 text-[#f59e0b] text-xs font-medium px-3 py-1 rounded-full mb-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-sm text-[#8899bb]">
                  <span className="w-5 h-5 rounded-full bg-[#00d4aa]/10 flex items-center justify-center shrink-0 mt-0.5">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                      <path d="M2 5l2 2 4-4" stroke="#00d4aa" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </span>
                  {item}
                </li>
