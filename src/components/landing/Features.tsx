...
const features = [
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <rect x="2" y="2" width="18" height="18" rx="4" stroke="#00d4aa" strokeWidth="1.5"/>
        <path d="M6 14l3-3 3 2 4-5" stroke="#00d4aa" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    bg: "bg-[#00d4aa]/10",
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 11h14M4 7h14M4 15h8" stroke="#4ade80" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
    bg: "bg-[#4ade80]/10",
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        <path d="M11 7v4l3 2" stroke="#f59e0b" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
    bg: "bg-[#f59e0b]/10",
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M3 3h16v10H3zM7 17h8M11 13v4" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    bg: "bg-[#f87171]/10",
...
const Features = () => {
  ...
  return (
    <section id="features" className="py-24 px-6 relative overflow-hidden">
      {/* Subtle orb */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#00d4aa]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
          ...
          {features.map((f, i) => (
            <div
              ...
              className={`glass-card rounded-2xl p-6 cursor-default transition-all duration-300 ${
                hovered === i
                  ? "border-[#00d4aa]/25 bg-[#00d4aa]/3 -translate-y-1"
                  : ""
              }`}
            >
              {/* Icon */}
        ...
        <div className="mt-16 glass-card rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="/register"
            className="shrink-0 inline-flex items-center gap-2 bg-[#00d4aa] text-[#080d1a] font-medium px-6 py-3 rounded-xl text-sm hover:opacity-90 transition-all duration-200 hover:-translate-y-0.5 shadow-lg shadow-[#00d4aa]/20"
          >
